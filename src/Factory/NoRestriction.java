...
public class NoRestriction extends Macronutrient {
    ...
    ArrayList<Macronutrient> makeMeal(String customerName, String dietPlan)
    {
        ...
        ArrayList<String> carbs = new ArrayList<>(Arrays.asList("Cheese", "Bread", "Lentils", "Pistachio"));
        ArrayList<String> proteins =new ArrayList<>(Arrays.asList("Fish", "Chicken", "Beef", "Tofu"));
        ArrayList<String> fats = new ArrayList<>(Arrays.asList("Avocado", "Sour Cream", "Tuna", "Peanuts"));
